...
<div class="body-profile">
    ...
    <section class="view-clothes">
        ...
        $stmt = $dbh->prepare("SELECT * FROM products WHERE idCustomer = ?");
        if ($stmt->execute(array($_SESSION['username']))) {
            while ($row = $stmt->fetch()) {

                echo ' <div class="view-clothes-container">
            <span class="view-clothes-wrap">
                <img src="data:image/jpeg;base64,' . base64_encode($row['image']) . '" height="260px">
            ...
            <p>Brand.</p><input data-update="brand" name="txtBrand" type="text" data-type="string" data-min="3" data-max="3000" value="' . $row['brand'] . '">
        ...
        $('#clicker').click(function() {
            $('.edit-inputs').each(function() {
                if ($(this).attr('disabled')) {
                    ...
                    $(this).css({
                        'background': 'rgba(180, 245, 253, 0.59)',
                        "border": "none"
                    });
