...
if ($queryt->rowCount() == 1) {
    ...
    // Query for Insertion
    $sql = "INSERT INTO products (`idCustomer`,`idWarehouse`,`title`,`description`,`image`,`size`,`condition`,`price`,`gender`,`idCategory`,`idBrand`,`color`) 
            VALUES (:idCustomer,:idWarehouse,:title,:description,:image,:size,:condition,:price,:gender,:idCategory,:idBrand,:color)";
